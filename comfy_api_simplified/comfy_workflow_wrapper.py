...
class ComfyWorkflowWrapper(dict):
    def __init__(self, path: str):
        ...
        """
        # Explicitly use UTF-8 when reading the workflow file to avoid
        # platform-dependent default-encoding issues (for example, CP936/GBK
        # on some Windows setups which can raise UnicodeDecodeError).
